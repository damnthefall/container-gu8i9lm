...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gu8i9lm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gu8i9lm.containers.anotherwebservice.com/
...
```
git clone git@github.com:damnthefall/container-gu8i9lm.git
cd container-gu8i9lm
```
...
```
docker attach container-gu8i9lm
```
